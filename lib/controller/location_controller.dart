  ...
  Future<AddressModel> getCurrentLocation(bool fromAddress, {GoogleMapController? mapController, LatLng? defaultLatLng, bool notify = true}) async {
    ...
    try {
      ...
      _myPosition = Position(
        latitude: defaultLatLng != null ? defaultLatLng.latitude : double.parse(Get.find<SplashController>().configModel!.defaultLocation!.lat!.isNotEmpty?Get.find<SplashController>().configModel!.defaultLocation!.lat! : '0'),
        longitude: defaultLatLng != null ? defaultLatLng.longitude : double.parse(Get.find<SplashController>().configModel!.defaultLocation!.lng!.isNotEmpty?Get.find<SplashController>().configModel!.defaultLocation!.lng!:  '0'),
