...
class BannerModel {
 late List<BasicCampaignModel> campaigns;
...
class Banner {
 ...
 Product ?food;
  ...
  Banner(
      {required this.id, required this.title, required this.type, required this.image, required this.restaurant, required this.food});
