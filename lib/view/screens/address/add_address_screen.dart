              ...
              child: !locationController.isLoading ? CustomButton(
                ...
                onPressed: locationController.loading ? null : () {
                  AddressModel _addressModel = AddressModel(
                    ...
                    contactPersonName: _contactPersonNameController.text.isNotEmpty?_contactPersonNameController.text:  '',
                    contactPersonNumber: _contactPersonNumberController.text.isNotEmpty? _contactPersonNumberController.text:  '',
                    address: _addressController.text .isNotEmpty? _addressController.text: '',
                    latitude: locationController.position.latitude.toString().isNotEmpty?locationController.position.latitude.toString():  '',
                    longitude: locationController.position.longitude.toString().isNotEmpty?locationController.position.longitude.toString() : '',
